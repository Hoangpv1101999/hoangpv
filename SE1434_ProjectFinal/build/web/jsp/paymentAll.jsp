<%-- 
    Document   : paymentAll
    Created on : Mar 27, 2021, 9:39:47 PM
    Author     : ADMIN
--%>
...
<html>
    ...
    <body>
        ...
        <h2 style="margin-top: 30px;text-align: center;color: #00e58b">Thanh toán</h2>
        <div style="margin-left: 50px;margin-right: 50px;margin-top: 50px">
            <table   class="table table-bordered">
                <thead>
                    <tr>
                        <th scope="rowgroup">Tên sản phẩm</th>
                        <th scope="rowgroup">Đơn giá nhập($)</th>
                        <th scope="rowgroup">Số lượng(nhập)</th>
                        <th scope="rowgroup">Đơn giá xuất($)</th>
                        <th scope="rowgroup">Số lượng(xuất)</th>
                        <th scope="rowgroup">Thanh toán($)</th>
                        <th scope="rowgroup">Công nợ($)</th>
                        <th scope="rowgroup">Tồn kho</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>${amountProduct.name}</td>
                        <td>${paymentOrder.payment}</td>
                        <td>${amountProduct.amount}</td>
                        <td>${paymentProduct.payment}</td>
                        <td>${amountProduct.amount}</td>
        ...
        <br>
        <br>
        <nav style="margin-top: 200px;" class="footer">
            <div>
