<%-- 
    Document   : insertExport
    Created on : Mar 20, 2021, 10:56:04 PM
    Author     : ADMIN
--%>
...
<html>
    ...
    <body>
        ...
        <h2 style="margin-top: 30px;text-align: center;color: #00e58b">Thêm sản phẩm</h2>
        <form action="insertExport" method="post">
            ...
            <table >
                ...
                <div style="margin-top: 30px;margin-left: 500px;margin-right: 500px;">
                    ...
                    <div >
                        <label for="lastName" class="form-label">Tên sản phẩm</label>
                    ...
                    <div >
                        <div >
                            <label class="input-group-text">Số  bó</label>
                            <input type="number" class="form-control" name="punch"  required>
                        </div>
                    </div>
                    <br>

                    <div >
                        <label for="email" class="form-label">Số sản phẩm/bó</label>
                        <input type="number" name="punch1" class="form-control" >
                    ...
                    <div >
                        <label for="email" class="form-label">Người giao hàng</label>
                        <input type="text" name="producer" class="form-control" >

                    </div><br>
                    <div >
                        <label for="email" class="form-label">Người nhận hàng</label>
                        <input type="text" name="supplier" class="form-control" >
                    </div><br>
                    <div >
                        <label for="email" class="form-label">Đơn hàng</label>
