<%-- 
    Document   : updateExport
    Created on : Mar 23, 2021, 10:37:20 PM
    Author     : ADMIN
--%>
...
<html>
    ...
    <body>
        ...
        <h2 style="margin-top: 30px;text-align: center;color: #00e58b">Chỉnh sửa đánh giá</h2>
        <div style="margin-left: 500px;margin-right: 500px;">
            <form action="updateExport" method="post"  class="needs-validation" novalidate>
                <table >
                    <div >
                        <div >
                            <label for="order" class="form-label">Mã sản phẩm</label>
                            <input type="number" class="form-control" readonly  name="proid" value="${exportByid.productId}"  required>

                        </div>
                        <br>

                        <div >
                            <label for="lastName" class="form-label">Hàng kém chất lượng</label>
                            <input type="text" class="form-control"   name="low" value="${exportByid.lowQuality}"   required>
                        ...
                        <div >
                            <div >
                                <label class="input-group-text">Hàng không đủ tiêu chuẩn</label>
                                <input type="text" class="form-control" name="quali" value="${exportByid.qualified}"  required>
                            </div>
                        </div>
                        <br>

                        <div>
                            <label for="email" class="form-label">Đơn giá</label>
                            <input type="text" name="payment" value="${exportByid.payment}" class="form-control" >
