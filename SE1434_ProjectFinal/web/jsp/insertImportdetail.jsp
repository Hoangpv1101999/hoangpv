<%-- 
    Document   : insertImportdetail
    Created on : Mar 18, 2021, 8:26:42 AM
    Author     : ADMIN
--%>
...
<html>
    ...
    <body>
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                            <ul class="nav navbar-nav">
                                <li class="dropdown">
                                    <a href="main" class="dropdown-toggle" >Sản phẩm<b class="caret"></b></a>

                                </li>
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Xuất nhập<b ></b></a>
        ...
        <div >
            <div >
                <h4 style="margin-top: 30px;text-align: center;color: #00e58b" >Chi tiết đơn hàng </h4>
                <form action="insertImportdetail" method="post"  class="needs-validation" novalidate>
                    <div style="margin-left: 500px;margin-right: 500px;">
                        <div >
                            <label for="order" class="form-label">Đơn hàng</label>
                            <input type="number" class="form-control"  name="orderid" value="" required>

                        </div>
                        <br>

                        <div >
                            <label for="lastName" class="form-label">tên hàng hóa</label>
                        ...
                        <div >
                            <div >
                                <label class="input-group-text">DVT</label>
                                <input type="text" class="form-control" name="dvt"   required>
                            </div>
                        </div>
                        <br>
                        ...
                        <br>
                        <div >
                            <label for="email" class="form-label">KHSX</label>
                            <input type="text" name="khsx" class="form-control" >
