<%-- 
    ...
    Created on : Mar 17, 2021, 10:23:06 PM
    Author     : ADMIN
--%>
...
<html>
    ...
    <body>
        ...
        <div class="insert">
            ...
            <h4 style="margin-top: 20px;color: #00e58b;text-align: center">Sản phẩm </h4>
            <div style="margin-left: 500px;margin-right: 500px;">

                <form action="insertProduct" method="get" class="needs-validation" novalidate>
                    <div >
                        <div >
                            <label for="order" class="form-label">Số sản phẩm</label>
                            <input type="number" class="form-control" readonly name="orderid" value="${orderidS}"  required>
                        ...
                        <div >
                            ...
                            <input type="text" class="form-control" id="lastName" name="name" value=""  required>
                        ...
                        <div >
                            <label for="email" class="form-label">Thanh toán</label>
