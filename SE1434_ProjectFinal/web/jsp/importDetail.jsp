<%-- 
    ...
    Created on : Mar 17, 2021, 1:36:29 PM
    Author     : ADMIN
--%>
...
<html>
    ...
    <body>
        ...
        <link href="css/insertDetail.css" rel="stylesheet" type="text/css"/>
        <h6>Chi tiết đơn hàng</h6>
        <a style="float: right;margin-right: 30px;padding: 4px" class="detail" href="insertImportdetail">Thêm hàng hóa</a>

        <div style="margin-left:  50px;margin-right:  50px" class="table">
            <table class="table table-bordered">
                <thead >
                    <tr>
                        <th scope="rowgroup">Sản phẩm hàng hóa</th>
                        <th scope="rowgroup">ĐVT</th>
                        <th scope="rowgroup">Số lượng</th>
                        <th scope="rowgroup">Ghi chú</th>
                        <th scope="rowgroup">KHSX</th>
                    </tr>
                </thead>
                <tbody>
                    <c:forEach var="i" items="${requestScope.importDetail}">
                        <tr>
                            <td>${i.name}</td>
                            <td>${i.dvt}</td>
                            <td>${i.amount}</td>
