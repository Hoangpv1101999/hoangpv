<%-- 
    Document   : payment
    Created on : Mar 27, 2021, 8:02:03 PM
    Author     : ADMIN
--%>
...
<html>
    ...
    <body>
                                    ...
                                    <ul class="dropdown-menu multi-column columns-3">
                                        <div class="row">
                                            <div class="multi-gd-img">
                                                <ul class="multi-column-dropdown">
                                                    <h6>Danh sách</h6>
                                                    <li><a href="payment">Tồn kho</a></li>
                                                </ul>
                                            </div>	
                                        </div>
                                    </ul>
        ...
        <h2 style="margin-top: 30px;text-align: center;color: #00e58b">Sản phẩm</h2>
        <div style="margin-left: 50px;margin-right: 50px;">

            <table   class="table table-bordered">
                <thead>
                    <tr>
                        <th scope="rowgroup">Mã sản phẩm</th>
                ...
                <tbody>
                    <c:forEach  var="p" items="${requestScope.products}">
                        <tr>
                            ...
                            <td>${p.amount}</td>
                            <td>
                                <a href="paymentAll?productid=${p.id}">Thanh toán>></a>
                            </td>
                        </tr>
                    </c:forEach>
